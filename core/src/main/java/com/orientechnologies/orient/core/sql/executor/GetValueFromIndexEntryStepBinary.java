...
public class GetValueFromIndexEntryStepBinary extends AbstractExecutionStep {
   ...
   */
  public GetValueFromIndexEntryStepBinary(OCommandContext ctx, int[] filterClusterIds, boolean profilingEnabled) {
      ...
      private void fetchNextItem() {
        ...
        while (!finished) {
          ...
          try {
            ...
            if (finalVal instanceof OIdentifiable) {
              OResultInternalBinary res = new OResultInternalBinary();
              res.setElementBinary((OIdentifiable) finalVal);
              nextItem = res;
